...
RULES: list[Rule] = [
    ...
    "Hardcoded default credentials used for API access",
    "high",
    re.compile(r"""(?i)(x-api-key|authorization|api[_-]?token|access[_-]?token|uptrain-access-token)\s*[:=]\s*['"]uptrain-user['"]"""),
    (),
),
