...
RULES: list[Rule] = [
    ...
    "agentic-subprocess-shell-true-unsafe",
    "Agentic framework subprocess.Popen with shell=True and safety=False",
    "high",
    re.compile(r"subprocess\.Popen\([^)]*shell\s*=\s*True[^)]*safety\s*=\s*False"),
    (".py",),
)
