...
RULES: list[Rule] = [
    ...
    "unsafe-deserialization-java-metadata",
    "Unsafe deserialization of untrusted file metadata (Java specific)",
    "high",
    re.compile(r"(?i)\bObjectInputStream\.(readObject|readUnshared)"),
    (".java",),
)
